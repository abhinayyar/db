...
class Disk {
  private:
    ...
    constexpr static const double avg_seek_time=6.46;
    constexpr static const double avg_rotation_latency=4.17;
    constexpr static const double avg_transfer_time_per_block=0.20 * 320;
