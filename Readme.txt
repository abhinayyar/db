...
###########DB Project 2#######
##############################
Step 1  : Compile code using script : ./run.sh (in Code dir)
...
-> As it is dynamic library you will require StorageManager.so during execution of binary dbparser
-> If path is not exported, you can use 
	export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/<path of .so file, in this case, DB project dir> 
